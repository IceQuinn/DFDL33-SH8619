...
Inv_ProtoData_Ua_Id_t g_inv_Ua[] = {    // A相电压寄存器
    ...
    {INV_MFR_SINENG_1,    {31000,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     1,      0}},
...
Inv_ProtoData_Ub_Id_t g_inv_Ub[] = {    // B相电压寄存器
    ...
    {INV_MFR_SINENG_1,    {31006,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     1,      0}},
...
Inv_ProtoData_Uc_Id_t g_inv_Uc[] = {    // C相电压寄存器
    ...
    {INV_MFR_SINENG_1,    {31012,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     1,      0}},
...
Inv_ProtoData_Ia_Id_t g_inv_Ia[] = {    // A相电流寄存器
    ...
    {INV_MFR_SINENG_1,    {31001,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     2,      0}},
...
Inv_ProtoData_Ib_Id_t g_inv_Ib[] = {    // B相电流寄存器
    ...
    {INV_MFR_SINENG_1,    {31007,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     2,      0}},
...
Inv_ProtoData_Ic_Id_t g_inv_Ic[] = {    // C相电流寄存器
    ...
    {INV_MFR_SINENG_1,    {31013,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     2,      0}},
...
Inv_ProtoData_Pt_Id_t g_inv_Pt[] = {    // 总功率寄存器
    ...
    {INV_MFR_SINENG_1,    {31018,        2,            0x03,   TYPE_I32, Type_Byte_ABCD,     3,      0}},
...
Inv_ProtoData_Qt_Id_t g_inv_Qt[] = {    // 总无功功率寄存器
    ...
    {INV_MFR_SINENG_1,    {31020,        2,            0x03,   TYPE_I32, Type_Byte_ABCD,     3,      0}},
...
Inv_daily_energy_Id_t g_inv_daily_energy[] = {    // 日发电量寄存器
    ...
    {INV_MFR_SINENG_1,    {34025,        1,            0x03,   TYPE_U16, Type_Byte_ABCD,     1,      0}},
