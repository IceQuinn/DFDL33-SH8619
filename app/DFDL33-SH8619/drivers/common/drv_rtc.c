...
static rt_err_t _rtc_get_secs(void *arg)
{
    time_t *args = arg;
...
static rt_err_t _rtc_set_secs(void *arg)
{
    time_t *args = arg;
...
static rt_err_t _rtc_get_alarm(void *arg)
{
#ifdef RT_USING_ALARM
    struct rt_rtc_wkalarm *alarm = arg;
...
static rt_err_t _rtc_set_alarm(void *arg)
{
#ifdef RT_USING_ALARM
...
static rt_err_t _rtc_get_timeval(void *arg)
{
